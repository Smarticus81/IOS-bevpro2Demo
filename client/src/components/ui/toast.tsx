...
>(({ className, ...props }, ref) => (
  <ToastPrimitives.Viewport
    ref={ref}
    className={cn(
      "fixed bottom-0 right-0 z-[100] flex max-h-screen flex-col-reverse p-2 sm:p-3 md:max-w-[380px]",
      className
    )}
    {...props}
  />
