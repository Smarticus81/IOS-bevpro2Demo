// This file has been removed as we no longer use intent prediction
// Direct command processing is now handled in VoiceControl.tsx

import { getOpenAIClient } from "./openai";
//import type { Intent } from "./openai"; //Removed as Intent is no longer used


// Parse YAML-like intents file
//function parseIntents(content: string): {  //Removed as parseIntents is no longer used
...
//export class IntentPredictor { //Removed as IntentPredictor is no longer used
...
//export const intentPredictor = IntentPredictor.getInstance(); //Removed as intentPredictor is no longer used